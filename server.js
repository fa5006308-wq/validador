...
// Conexión a Mongo al iniciar (sin fixes ni índices parciales)
(async () => {
  try {
    ...
    // Índice simple y único (ya no usamos partialFilterExpression)
...
// /validar?id=CODIGO  ->  VÁLIDO / NO VÁLIDO
